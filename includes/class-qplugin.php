...
class Qplugin {
   ...
   * @since    1.0.0
   * @access   protected
   * @var      Qplugin_Loader    $loader    Maintains and registers all hooks for the plugin.
   */
  protected $loader;
   ...
   *
   * - Qplugin_Loader. Orchestrates the hooks of the plugin.
   * - Qplugin_i18n. Defines internationalization functionality.
   * - Qplugin_Admin. Defines all hooks for the admin area.
   * - Qplugin_Public. Defines all hooks for the public side of the site.
   *
   ...
   *
   * Uses the Qplugin_i18n class in order to set the domain and to register the hook
   * with WordPress.
   *
   * @since    1.0.0
   * @access   private
   ...
   *
   * @since     1.0.0
   * @return    Qplugin_Loader    Orchestrates the hooks of the plugin.
   */
